...
onMounted(() => {
  ...
  /**
   * Removes the preloader element from the DOM after the page has loaded
   */
  if (preloader) {
  ...
  /**
   * Adds click event listeners to the scroll-to-top button
  ...
  /**
   * Adds event listeners to toggle the scroll-to-top button based on scroll position
   */
  ...
  <div class="row gy-4">
    <div class="col-lg-4 col-md-6 footer-about">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="@/assets/img/logo.png" width="30" height="30" alt=""> <span class="sitename">JA</span>
      </a>
